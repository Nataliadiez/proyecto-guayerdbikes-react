...
import { useStyles } from '../TablaNosotros/TablaNosotros.style'
...
const DescripcionNosotros = () => {
    ...
    return (
        <>
        <Typography className={classes.tituloContacto} variant="h4">Nosotros</Typography>
        <Typography className={classes.fuentes} align="left" variant="h5" color="initial">Guayerd Bikes</Typography>
        <Typography align="justify" variant="body" color="initial">
            ...
            Ese menosprecio hacia los productos del país de origen de Bill Jobs le llevó a abrir, la que sería, la primera fábrica de Guayerd Bikes en 1972.<br/>

            El sentido que Bill Jobs le daba a su vida era la de moverse con pasión y decisión. El nombre de “Guayerd” no es casual, ya que surge de la unión de tres sílabas chinas Gu-ah-yerd, cuyo significado evoca la fabricación de un producto de calidad, atractivo y capaz de llevar a sus usuarios al destino de la forma más placentera posible.<br/>

            Bill Jobs no habría sido el mismo si no hubiese llegado a cumplir su objetivo principal de ofrecer bicicletas de calidad fabricadas en suelo argentino. Otro paso importante en su carrera profesional fue el lanzamiento de GUAYERD como marca propia. A diferencia de otros fabricantes, Guayerd Bikes si optó por apostar por su propia marca en la que quedaría patente toda la filosofía del propio Jobs. Desde que Guayerd fue fundada como marca independiente, todos los cuadros y bicicletas fabricadas bajo la marca taiwanesa debían cumplir con tres premisas “Gu-ah-yerd”.<br/>

            En 2013, GUAYERD cumplió su 25 aniversario, portando con orgullo la filosofía con la que Bill Jobs fundase la primera fábrica en 1972.<br/>
        ...
        <hr/>
        <Typography className={classes.fuentes} align="left" variant="h5" color="initial">Innovación</Typography>
        <Typography align="justify" variant="body" color="initial">
        ...
        <hr/>
        <Typography className={classes.fuentes} align="left" variant="h5" color="initial">Bicis</Typography>
        <Typography align="justify" variant="body" color="initial">
            ...
            El sueño que Bill Jobs tuvo en la década de los 70 es hoy una realidad. Taiwán se ha convertido en un “Silicon Valley” de la industria del ciclismo. Todas las grandes marcas del sector aspiran a fabricar sus bicicletas o componentes en Taiwán y ya nunca más se volverá a ver un cartel en el que se rechacen productos del país asiático por su escasa calidad.<br/>
        ...
        <hr/>
        <Typography className={classes.fuentes} align="left" variant="h5" color="initial">Más éxitos</Typography>
        <Typography align="justify" variant="body" color="initial">
        ...
        <hr/>
        <Typography className={classes.fuentes} align="left" variant="h5" color="initial">Premios</Typography>
        </>
    )
}
